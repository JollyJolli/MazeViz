// Breadth-First Search Algorithm for MazeViz
 ...
 */
async function solveMazeWithBFS(maze, updateCallback) {
    ...
    queue.push(maze.grid[startRow][startCol]);
    ...
    while (queue.length > 0) {
        ...
        for (const neighbor of neighbors) {
            if (!neighbor.visited) {
                ...
                // Add to visited cells and queue
